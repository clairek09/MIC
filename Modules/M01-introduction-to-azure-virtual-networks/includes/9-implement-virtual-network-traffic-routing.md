...
|**Source**|**Addres prefixes**|**Next hop type**|
|---|---|---|
...
1.	In the search box, enter the name of the VM that you want to investigate. 
1.	Select the VM from the search results.
1.	Under **Settings**, select **Networking**, and navigate to the network interface resource by selecting its name.

![view-nics](../media/view-nics.png)
...
![view-effective-routes](../media/view-effective-routes.png)
...
![forced-tunnel](../media/forced-tunnel.png)
