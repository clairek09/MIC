...
\[!div class="mx-imgBorder"\] :::image type="content" source="../media/kunenet-overview-2c08edda.png" alt-text="diagram shows how the AKS nodes receive an IP address in the virtual network subnet, but not the pods":::
